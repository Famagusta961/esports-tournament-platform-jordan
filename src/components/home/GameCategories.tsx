...
const GameCategories = () => {
  ...
  const games = [
    {
      id: 'pubg-mobile',
      name: t('home.gameNames.pubg.mobile') || 'PUBG Mobile',
      shortName: 'PUBGM',
    ...
    {
      id: 'ea-fc',
      name: t('home.gameNames.eafc.name') || 'EA FC 25',
      shortName: 'EA FC',
    ...
    {
      id: 'valorant',
      name: t('home.gameNames.valorant') || 'Valorant',
      shortName: 'VAL',
    ...
    {
      id: 'cod-mobile',
      name: t('home.gameNames.cod.mobile') || 'COD Mobile',
      shortName: 'CODM',
    ...
    {
      id: 'fortnite',
      name: t('home.gameNames.fortnite') || 'Fortnite',
      shortName: 'FN',
    ...
    {
      id: 'lol',
      name: t('home.gameNames.lol') || 'League of Legends',
      shortName: 'LoL',
        ...
        <div className="flex items-center justify-between mb-12">
          <div>
            <h2 className="font-display text-3xl sm:text-4xl font-bold mb-2">
              {t('home.gameCategories.title').split('<span>').map((part: string, index: number) => {
            ...
            <p className="text-muted-foreground font-gaming">
              {t('home.gameCategories.subtitle')}
            </p>
          </div>
          <Link 
            to="/games" 
          ...
          >
            <span>{t('home.gameCategories.viewAllGames')}</span>
              ...
              <div className="relative p-4 sm:p-6 text-center">
                ...
                <div className="flex items-center justify-center space-x-2 text-xs text-muted-foreground">
                  <span className="px-2 py-1 rounded-full bg-primary/10 text-primary">
                    {game.activeTournaments} {t('home.gameCategories.activeTournaments')}
                  </span>
                </div>
              </div>
