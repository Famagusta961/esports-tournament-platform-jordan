...
const Wallet = () => {
  ...
  // Static data only - no effects, no API calls
  const balance = 0.00;
  ...
  // Static wallet UI - no loading state
  return (
            ...
            <Card className="bg-card border-border p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-display font-semibold text-green-500">0.00 JOD</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="bg-card border-border p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-display font-semibold text-blue-500">0.00 JOD</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="bg-card border-border p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-display font-semibold text-orange-500">0.00 JOD</p>
                </div>
              </div>
            </Card>
          </div>
